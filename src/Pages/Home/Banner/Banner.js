        ...
        <div className="hero bg-base-200">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div>
                    ...
                    <p className="text-text-lime-900 py-6">If you are looking for second hand cars with the minimum price, you are in the right place.We provide best condition cars with minimum price. </p>
